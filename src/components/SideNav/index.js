  ...
  return (
    <div className="side-nav">
      ...
      <div className="section-title">
        ...
        >
          {" "}
          Click to show or hide products
        </button>
        ...
        >
          Click to recompute value with toggling{" "}
        </button>
        <button
          onClick={() => {
            getMemoisedValue();
        ...
        >
          Click to recompute value without toggling{" "}
        </button>
        ...
        <button
          onClick={() => {
            dispatch(
              addItemToProduct({
                id: randomIntBetweenInterval(20, 100),
            ...
            return (
              <div className="accordion-item individual-category">
                <div className="accordion-header">
                  <button
                    id={"but" + eachData.category}
                    className="accordion-button"
                    data-bs-target={"#" + eachData.category}
                    data-bs-toggle="collapse"
                  >
                    <div className="category-title">{eachData.category}</div>
                  </button>
                </div>

                {accordionData.filter(
                  (eachSubCategory) =>
                    eachData.id == eachSubCategory.parent_category_id
                ).length > 0 && (
                  <div
                    className="accordion-collapse collapse show"
                    id={eachData.category}
                  >
